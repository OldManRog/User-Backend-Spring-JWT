...
public class EmailConstants {
    ...
    public static final String USERNAME = "olivarogerr@gmail.com";
    public static final String PASSWORD = "Zmilan7075";
    public static final String FROM_EMAIL = "RogerrService.com";
