...
import static com.example.supportportal.constant.EmailConstants.*;
...
public class EmailService {
    ...
    public void sendNewPasswordEmail(String firstName, String password, String email) throws MessagingException {
        MimeMessage message = createEmail(firstName,password,email);
    ...
    private MimeMessage createEmail(String firstName, String password, String email) throws MessagingException {
        ...
        message.setRecipients(CC, InternetAddress.parse(CC_EMAIL));
